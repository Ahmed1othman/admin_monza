...
<head>
    ...
    @endif
    <link rel="icon" href="{{url('/') . '/website/images/fav.jpg'}}" type="image/x-icon">
                ...
                <div class="col-lg-9">
                    <ul>
                        ...
                        @foreach(\App\Models\Type::get() as $t)
                            ...
                            <li>
                                <a data-toggle="tooltip" data-placement="left" title="{{__('lang.Rent')}} {{$t->title}}" href="{{url('/')}}/t/{{$t->sync_id}}/{{$t->slug()}}">{{__('lang.Rent')}} {{$t->title}}</a>
                            </li>
                        @endforeach
