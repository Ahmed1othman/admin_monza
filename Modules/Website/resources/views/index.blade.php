...
@section('seo')
    @include('website::layouts.parts.seo', [
        ...
        "image" => url('/') . '/website/images/fav.jpg'
    ])
@endsection
...
@section("content")
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div data-items-large="6" data-is-loop="false" data-items-small="2" class="home__brands_content owl-carousel owl-theme">
                        ...
                        <a href="{{$item->external_url ? $item->external_url : url('/') . '/t/' . $item->sync_id .'/' . $item->slug()}}">
                            <div class="home__brands_item">
                                <img width="174" height="100" loading="lazy" alt="{{$item->title . rand(0,9999)}}" src="/storage/{{$item->image}}"/>
                                <h3>{{$item->title}}</h3>
                            </div>
                        </a>
                        @endforeach
                ...
                <div class="col-lg-12">
                    <div data-items-large="6" data-items-small="2"  class="home__features_content home__rental_companies owl-carousel owl-theme">
                        ...
                        <div class="product__vertical">
                            <a href="{{url('/')}}/c/{{$company->id}}/{{$company->slug()}}">
                            <div class="product__vertical_top">
    
                                <img loading="lazy" alt="{{$company->name}}" src="{{url('/')}}/storage/{{$company->image}}"/>
                            </div>
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="home__find_your_car_item">
                        <img width="55" height="55" alt="icon" src="{{url('/')}}/website/images/icons/list.png"/>
                ...
                <div class="col-lg-1">
                    <div class="home__find_your_car_line">
                        <img width="187" height="35" alt="icon" src="{{url('/')}}/website/images/curve_up.png" />
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home__find_your_car_item">
                        <img width="55" height="55" alt="icon" src="{{url('/')}}/website/images/icons/calendar.png"/>
                ...
                <div class="col-lg-1">
                    <div class="home__find_your_car_line">
                        <img  width="187" height="35" alt="icon" src="{{url('/')}}/website/images/curve_down.png" />
                    </div>
                </div>
                <div class="col-lg-3">
                    <div class="home__find_your_car_item">
                        <img  width="55" height="55" alt="icon" src="{{url('/')}}/website/images/icons/check_ic.png"/>
    ...
    <section class="home__book_your_next_trip">
        <img class="bg" src="/website/images/your_next_trip_bg.webp" alt="bg" loading="lazy" />
        <div class="container">
            <div class="row">
                <div class="col-lg-5">
