                        ...
                        <a href="#cars" data-toggle="collapse" aria-expanded="false"class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-car">
                                  <path d="M3 12h1.5l1.5-4h12l1.5 4H21v4H3v-4z"></path>
...
{{--                        </a>--}}
                    ...
                    <li class="menu">
                        <a href="#dashboard2" data-toggle="collapse" aria-expanded="false"class="dropdown-toggle">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-settings">
                              ...
                              <path d="M12 4a1 1 0 0 1 1 1v1a1 1 0 0 1-2 0V5a1 1 0 0 1 1-1zm0 14a1 1 0 0 1 1 1v1a1 1 0 0 1-2 0v-1a1 1 0 0 1 1-1zm8.66-8.66a1 1 0 0 1 .27 1.4l-.7 1.2a1 1 0 0 1-1.4.27l-1.2-.7a1 1 0 0 1-.27-1.4l.7-1.2a1 1 0 0 1 1.4-.27l1.2.7zm-13.32.27a1 1 0 0 1 .27 1.4l-.7 1.2a1 1 0 0 1-1.4.27l-1.2-.7a1 1 0 0 1-.27-1.4l.7-1.2a1 1 0 0 1 1.4-.27l1.2.7zm12.43 8.2a1 1 0 0 1 1.4-.27l1.2.7a1 1 0 0 1 .27 1.4l-.7 1.2a1 1 0 0 1-1.4.27l-1.2-.7a1 1 0 0 1-.27-1.4l.7-1.2zm-16.49 0a1 1 0 0 1 .27 1.4l-.7 1.2a1 1 0 0 1-1.4.27l-1.2-.7a1 1 0 0 1-.27-1.4l.7-1.2a1 1 0 0 1 1.4-.27l1.2.7z"></path>
                            </svg>
                    ...
                    <li class="menu">
                        <a href="{{url('/')}}/admin/service" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
                    ...
                    <li class="menu">
                        <a href="{{url('/')}}/admin/required-documents" aria-expanded="false" class="dropdown-toggle">
                            <div class="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-layout"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="9"></line></svg>
                                <span>{{__('admin.required_documents')}}</span>
                            </div>
                        </a>
                    </li>
                    @endcan
