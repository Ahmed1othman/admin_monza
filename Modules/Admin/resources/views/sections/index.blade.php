        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addModalLabel">{{__('admin.add')}} {{__('admin.category')}} {{__('admin.home')}}</h5>
                </div>
                ...
                <div class="modal-body">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-xl-9 col-lg-9 col-sm-10">
                                <input type="number" value="{{\App\Models\Section::count() + 1}}" required class="form-control" name="sort" >
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <div class="page__header_title">
                                            <h4>{{__('admin.categories')}} {{__('admin.home')}}</h4>
