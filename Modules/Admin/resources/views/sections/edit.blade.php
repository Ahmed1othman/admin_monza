...
@section('content')
            ...
            <div class="layout-px-spacing">
                <form action="{{url('/')}}/admin/sections/{{$item->id}}" method="post" enctype="multipart/form-data">
                    @method('put')
                    @csrf
                                ...
                                <div class="widget-content widget-content-area">
                                    <div class="row">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-9 col-lg-9 col-sm-10">
                                                <input type="text" value="{{$item->getTranslation('description', $key)}}" required class="form-control" name="description_{{$key}}" >
                                            </div>
                                        </div>
                                        @endforeach
