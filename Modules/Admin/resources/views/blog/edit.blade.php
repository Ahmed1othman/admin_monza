                                 ...
                                 <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            ...
                                            <div class="form-group row mb-4">
                                                ...
                                                <div class="col-xl-9 col-lg-9 col-sm-10">
                                                    <input id="tags_blog_{{$key}}" data-role="tagsinput" type="text" required class="form-control tag" name="meta_keywords_{{$key}}" placeholder="{{ __('') }}" value="{{$item->getTranslation('meta_keywords', $key)}}">
                                                </div>
                                            </div>
                                            @endforeach
