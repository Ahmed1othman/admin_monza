                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                        <div class="page__header_title">
                                            <h4>{{__('admin.required_document')}}</h4>
                                            <a href="{{url('/')}}/admin/required-documents/create" class="btn btn-primary btn-rounded">
                                                <svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="12" y1="5" x2="12" y2="19"></line><line x1="5" y1="12" x2="19" y2="12"></line></svg>
                                                {{__('admin.add')}} {{__('admin.required_document')}}
                                            </a>
                                        </div>
                                        ...
                                        <table id="style-3" class="table style-3  table-hover">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-center">{{__('admin.required_document_for')}}</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        {{$item->for =="native"?"مواطن" :"اجنبي"}} <br/>
                                                    </td>

                                                    <td class="text-center">
                                                        @foreach(\Config::get("app.languages") as $key => $value)
                                                            {{$item->getTranslation("content",$key)}} <br/>
                                                        @endforeach
                                                    </td>
