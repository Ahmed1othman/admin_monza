...
@section('content')
            ...
            <div class="layout-px-spacing">
                <form action="{{url('/')}}/admin/required-documents" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="page__header_title custom__page_header_title">
                        <h4>{{__('admin.add')}} {{__('admin.required_document')}}</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="form-group row mb-4">
                                                <label class="col-xl-3 col-sm-3 col-sm-2 col-form-label">{{__('admin.required_document_for')}}</label>
                                                <div class="col-xl-9 col-lg-9 col-sm-10">
                                                    <select class="form-control" name="for">
                                                        <option disabled value="">{{__('admin.choolse_from_list')}}</option>
                                                        <option value="native">مواطن</option>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-9 col-lg-9 col-sm-10">
                                                <textarea  class="form-control" name="content_{{$key}}" ></textarea>
                                            </div>
                                        </div>
                                        @endforeach
                                        </div>
