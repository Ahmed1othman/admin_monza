$(".owl-carousel").each(function () {
  ...
  $(document).on('click', function(event) {
    // Check if the click target is not a .header__actions_list_item or its descendant
    if (!$(event.target).closest('.header__actions_list_item').length) {
        // Your desired action when clicking outside .header__actions_list_item
  ...
  $(".select-brand").on("change", function () {
      ...
      $.ajax({
          ...
          type: "get",
          success: function (t) {
              $(".select-model").html("<option value=''>Choose Model</option>"),
  ...
  $(".read-more").click(function () {
      ...
      $(this).parent().find(".home__brands_desc").toggleClass("height-auto"), 
      $(this).parent().find(".home__brands_desc").hasClass("height-auto") ? $(this).html(ReadLess) : $(this).html(ReadMore);
  }),
...
$(".read-more-page").click(function () {
  ...
  $(this).parent().find("p").hasClass("height-auto") ? $(this).html(ReadLess) : $(this).html(ReadMore);
})

$(".expand-models").click(function(){
    var ReadMore = $(".tr-read-more").val();
  var ReadLess = $(".tr-read-less").val();
  $(this).parent().find(".product-page__sub_categories").toggleClass("height-auto"),
  $(this).parent().find(".product-page__sub_categories").hasClass("height-auto") ? $(this).html(ReadLess) : $(this).html(ReadMore);
})
